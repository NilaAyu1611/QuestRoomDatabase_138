...
import com.example.prak8.ui.viewmodel.UpdateMhsViewModel
...
fun UpdateMhsView(
    ...
    val uiState = viewModel.updateUIState   // ambil UI staet dari view model
    val snackbarHostState = remember { SnackbarHostState()}      // Snackbar state
    val coroutineScope = rememberCoroutineScope()

    //observasi perubahan snackbarmassege
